...
class MrpProductionRequestCreateMo(models.TransientModel):
    ...
    def _prepare_manufacturing_order(self):
        ...
        return {
            ...
            'date_send': request_id.datesend,
            'date_finish': request_id.datefinish,
        }
    ...
    def create_mo(self):
        ...
        mo_child_ids = self.env['mrp.production'].search([('name','like',mo.name),('id','!=',mo.id)])
        # print ('MO CHILD')
        # print (mo_child_ids)
        for mo_child in mo_child_ids:
            mo_child.button_plan()
        # Open resulting MO:
