...
#                     
#                     
#                     if invoice.team_id.commission_range_ids:
...
#                             total = amount
#                         for range in invoice.team_id.commission_range_ids:
#                             if total >= range.starting_range and total <=  range.ending_range:#2500 0 - 5000
#                                 sales_manager_commission = range.sales_manager_commission
#                                 sales_person_commission = range.sales_person_commission
