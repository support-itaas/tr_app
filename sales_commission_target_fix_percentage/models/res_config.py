...
#             'sale.config.settings', 'when_to_pay', self.when_to_pay)
    ...
    def get_values(self):
        ...
        res.update(
            when_to_pay = params.get_param('sales_commission_target_fix_percentage.when_to_pay'),
            commission_based_on = params.get_param('sales_commission_target_fix_percentage.commission_based_on')
        )
        return res
