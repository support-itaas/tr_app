...
class PurchaseRequest(models.Model):
    ...
    total_amount = fields.Float(string='Total Amount',compute='_amount_all',store=True)
...
class PurchaseRequestLine(models.Model):
    ...
    sub_total = fields.Float(string='Sub Total', compute='_compute_amount', store=True)
