...
class hr_contract(models.Model):
    ...
    public_holiday_type = fields.Many2one('hr.holidays.public',string='Holiday Type')

class HrPublicHolidaysType(models.Model):
...
class HrPublicHolidays(models.Model):
    ...
    type = fields.Many2one('hr.holidays.public.type',string='Public Holiday Type')
