...
class account_move(models.Model):
    ...
    is_check_ref = fields.Boolean(string='WHT Per Line')
...
class Account_Payment(models.Model):
    ...
    def get_break_line_receipt(self, max_body_height, new_line_height, row_line_height, max_line_lenght):
        break_page_line = []
        count_height = 0
        count = 1
        ...
        for line in self.invoice_ids:
            ...
            # print count
            line_height = row_line_height + ((self.get_lines(line.number, max_line_lenght)) * new_line_height)
