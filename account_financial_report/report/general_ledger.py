...
class GeneralLedgerReportCompute(models.TransientModel):
    ...
    def compute_data_for_report(self,
        ...
        # Add unaffected earnings account by Standard
        # Remove this account by JA - 17-08-2022
    ...
    def _get_final_account_sub_subquery_sum_amounts(self, date_included):
        ...
        subquery_sum_amounts = """
            SELECT
                ...
                SUM(COALESCE(sub.debit-sub.credit, 0.0)) AS balance,
...
SELECT
    ...
    COALESCE(f.debit-f.credit, 0.0) AS final_balance,
