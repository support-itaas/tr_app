...
SELECT
    ...
    coalesce((rag.final_debit - rag.initial_debit)-(rag.final_credit - rag.initial_credit), 0) AS period_balance,
    coalesce(rag.final_debit - rag.final_credit, 0) AS final_balance,
