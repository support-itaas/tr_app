        ...
        for col_pos, column in self.columns.items():
            ...
            if cell_type == 'many2one':
                ...
                self.sheet.write_number(
                    self.row_pos, col_pos, round(float(value),2), cell_format
                )
        ...
        for col_pos, column in self.columns.items():
            if column.get('field_initial_balance'):
                ...
                if cell_type == 'string':
                    ...
                    self.sheet.write_number(
                        self.row_pos, col_pos, round(float(value),2), self.format_amount
                    )
                elif cell_type == 'amount_currency':
        ...
        for col_pos, column in self.columns.items():
            if column.get('field_final_balance'):
                ...
                if cell_type == 'string':
                    ...
                    self.sheet.write_number(
                        self.row_pos, col_pos, round(float(value),2),
